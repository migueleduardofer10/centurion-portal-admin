    ...
    constructor(props) {
        ...
        this.state = {
            ...
            todos: [
                {
                    id: 1,
                    task: 'Call Foreclosure Lawyer',
                    isCompleted: false
                },
                {
                    id: 2,
                    task: 'Check Escrow Details for Loan 399XXXXX',
                    isCompleted: false
                },
                {
                    id: 3,
                ...
                {
                    id: 5,
                    task: 'Submit Daily Payoff Portfolio Value',
                    isCompleted: false
                }
            ],
            inputValue: '',
                            ...
                            <div className="card-body">
                                <div className="clearfix">
                                    ...
                                    <div className="float-right">
                                        <p className="mb-0 text-right text-dark">Principal Balance</p>
                        ...
                        <div className="card card-statistics">
                            <div className="card-body">
                                <div className="clearfix">
                                    ...
                                    <div className="float-right">
                                        <p className="mb-0 text-right text-dark">Active Loans</p>
                                        <div className="fluid-container">
                                            <h3 className="font-weight-medium text-right mb-0 text-dark">13455</h3>
                                        </div>
                                    </div>
                                </div>
                                <p className="text-muted mt-3 mb-0">
                                    <i className="mdi mdi-bookmark-outline mr-1" aria-hidden="true"></i> Total Year-to-Date </p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 grid-margin stretch-card">
                        <div className="card card-statistics">
                            <div className="card-body">
                                <div className="clearfix">
                                    ...
                                    <div className="float-right">
                                        <p className="mb-0 text-right text-dark">Payoff</p>
                                        <div className="fluid-container">
                                ...
                                <p className="text-muted mt-3 mb-0">
                                    <i className="mdi mdi-calendar mr-1" aria-hidden="true"></i> Yearly Report </p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 grid-margin stretch-card">
                        <div className="card card-statistics">
                            <div className="card-body">
                                <div className="clearfix">
                                    ...
                                    <div className="float-right">
                                        <p className="mb-0 text-right text-dark">New Loans</p>
                                        <div className="fluid-container">
                                ...
                                <p className="text-muted mt-3 mb-0">
                                    <i className="mdi mdi-reload mr-1" aria-hidden="true"></i>  Total Month-to-Date </p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div className="card-body">
                                        <div className="revenue-item d-flex">
                                            <div className="revenue-desc">
                                                <h6>User Tasks</h6>
                                                <p className="font-weight-light"> Average Complete tasks </p>
                                            </div>
                                            <div className="revenue-amount">
                                                <p className="text-secondary"> +168 </p>
                                            </div>
                                        </div>
                                        <div className="revenue-item d-flex">
                                            <div className="revenue-desc">
                                                <h6>Total Tasks</h6>
                                                <p className="font-weight-light"> Weekly Complete tasks </p>
                                            </div>
                                            <div className="revenue-amount">
                ...
                <div className="row">
                        ...
                        <div className="card">
                            <div className="card-body py-5">
                                <div className="d-flex flex-row justify-content-center align-items">
                                    <i className="mdi mdi-file-document text-facebook icon-lg"></i>
                                    <div className="ml-3">
                                        <h6 className="text-facebook font-weight-semibold mb-0">Daily Data Reports</h6>
                                        <p className="text-muted card-text">60</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body py-5">
                                <div className="d-flex flex-row justify-content-center align-items">
                                    <i className="mdi mdi-flag-variant text-google icon-lg"></i>
                                    <div className="ml-3">
                                        <h6 className="text-google font-weight-semibold mb-0">Action Needed</h6>
                                        <p className="text-muted card-text">20</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body py-5">
                                <div className="d-flex flex-row justify-content-center align-items">
                                    <i className="mdi mdi-view-dashboard text-twitter icon-lg"></i>
                                    <div className="ml-3">
                                        <h6 className="text-twitter font-weight-semibold mb-0">Available Pipelines</h6>
                                        <p className="text-muted card-text">4 New</p>
                                    </div>
                                </div>
                            </div>
                        </div>
