...
var PaidInvoicesStore = require("../../store/stores/invoices/PaidInvoicesStore");
var PaidInvoices = /** @class */ (function (_super) {
    __extends(PaidInvoices, _super);
    ...
    PaidInvoices.prototype.componentDidMount = function () {
        this.props.fetchInvoices(this.props.gridProps, true, false);
    };
    PaidInvoices.prototype.render = function () {
        var _this = this;
            ...
            React.createElement("div", { className: "card-group" },
                React.createElement("div", { className: "card" },
                    React.createElement("div", { className: "card-header p-0" },
                        React.createElement(TabsInvoices_1.default, { option: 2 })),
                    React.createElement("div", { className: "card-body" },
                        React.createElement("ul", { className: "list-inline ml-2 mb-2" },
                            React.createElement("li", { className: "list-inline-item ml-0 mr-3" },
                                React.createElement("select", { className: "form-control form-control-sm", value: this.props.lenderUid, onChange: function (event) { return _this.props.fetchInvoices(_this.props.gridProps, false, true, event.target.value); } },
                        ...
                        React.createElement(CustomGrid_1.default, { data: this.props.invoices, dataAll: this.props.invoicesAll, columns: this.props.columns, realColumns: this.props.realColumns, dataState: this.props.gridProps, fileName: "Pending_Invoices", exportExcel: this.props.exportExcel, currentPage: this.props.currentPage, withDetails: true, withContextMenu: true, menuOptions: ["Export Details"], forceUpdate: this.props.forceUpdate, fetchData: this.props.fetchInvoices, fetchDataAll: this.props.fetchInvoicesAll, fetchDataDetails: this.props.fetchInvoiceDetails, disableForceUpdate: this.props.disableForceUpdate, enableExportExcel: this.props.enableExportExcel, changedColumns: this.props.changedColumns, applyChangedColumns: this.props.applyChangedColumns, selectItem: this.props.selectInvoice, selectOption: this.selectOption }))))));
    };
    return PaidInvoices;
}(React.PureComponent));
exports.default = react_redux_1.connect(function (state) { return state.paidInvoices; }, PaidInvoicesStore.actions)(PaidInvoices);
//# sourceMappingURL=PaidInvoices.js.map