...
var Error404 = /** @class */ (function (_super) {
    ...
    Error404.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("div", { className: "d-flex align-items-center text-center error-page bg-info pt-5 pb-4 h-100" },
                React.createElement("div", { className: "row flex-grow" },
                    React.createElement("div", { className: "col-lg-8 mx-auto text-white" },
                        React.createElement("div", { className: "row align-items-center d-flex flex-row" },
                            React.createElement("div", { className: "col-lg-6 text-lg-right pr-lg-4" },
                                React.createElement("h1", { className: "display-1 mb-0" }, "404")),
                            React.createElement("div", { className: "col-lg-6 error-page-divider text-lg-left pl-lg-4" },
                                React.createElement("h2", null, "SORRY!"),
                                React.createElement("h3", { className: "font-weight-light" }, "The page you\u2019re looking for was not found."))),
