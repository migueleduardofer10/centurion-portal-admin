    ...
    var RenderGrid = function () {
        return (React.createElement(React.Fragment, null,
            ...
            props.GridDetailRowProps
                ? //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    (React.createElement(kendo_react_grid_1.Grid, __assign({ filterOperators: {
                            'text': [
                        ...
                        }, sortable: true, pageable: true, data: props.Rows, total: props.TotalRows }, props.GridState, { onSortChange: RenderGrid_Event_Sort, onPageChange: RenderGrid_Event_PageChange, onDataStateChange: RenderGrid_Event_DataStateChange, expandField: "expanded", onExpandChange: function (event) { return Grid_onExpandChange(event); }, detail: props.GridDetailRowProps }),
                ...
                : //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    (React.createElement(kendo_react_grid_1.Grid, __assign({ filterOperators: {
                        ...
                        }, sortable: true, pageable: true, data: props.Rows, total: props.TotalRows }, props.GridState, { onSortChange: RenderGrid_Event_Sort, onPageChange: RenderGrid_Event_PageChange, onDataStateChange: RenderGrid_Event_DataStateChange }),
                        React.createElement(kendo_react_grid_1.GridToolbar, null,
                            React.createElement("ul", { className: "list-inline mb-0" },
                                React.createElement("li", { className: "list-inline-item ml-0" },
                                    React.createElement("button", { className: "btn btn-primary", onClick: function (event) { return RenderGrid_GridToolBar_Event_Refresh(event); } },
...
exports.default = Grid002;
//# sourceMappingURL=Grid002.js.map