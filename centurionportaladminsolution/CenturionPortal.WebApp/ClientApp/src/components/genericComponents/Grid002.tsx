...
import { Grid, GridDataStateChangeEvent, GridPageChangeEvent, GridSortChangeEvent, GridToolbar, GridExpandChangeEvent, GridDetailRow, GridDetailRowProps, GridColumn } from '@progress/kendo-react-grid';
...
type PropsType = {
    ...
    GridDetailRowProps?: React.FC<GridDetailRowProps>,
    ...
    UseConfigureColumns?: boolean

}

const Grid002: React.FC<PropsType> = (props) => {
