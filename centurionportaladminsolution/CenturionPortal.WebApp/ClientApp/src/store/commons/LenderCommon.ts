...
const loanPrimaryPurpose = Enums.EnumToArray(Enums.LoanPrimaryPurposeEnum).map(item => {
...
export const initialColumnsAttachment: any[] = [
...
export const initialLenderDisbursement: any[] = [
